"Hacking horse" is a runner written in JavaScript. All you need to do to run this game is to download all the files from the repository and have a web-browser.
